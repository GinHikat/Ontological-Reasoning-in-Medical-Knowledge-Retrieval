...
from modules.components.postprocessing.llm_recall import LLMRecallPostProcessor
...
def build_v9_llm_recall_pipeline(
    ...
    """V9: v7_structured + additive non-overlapping LLM recall.

    Structurally copies v7_structured. Inserts LLMRecallPostProcessor after all
    existing recall generators and before CandidateMerge. Does not build on v8.
    """
